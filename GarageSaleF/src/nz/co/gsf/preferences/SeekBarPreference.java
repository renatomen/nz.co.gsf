...
public class SeekBarPreference extends DialogPreference implements
    ...
    private static final String customns = "http://schemas.android.com/apk/res/nz.co.gsf";
    ...
    private void setProgressText(int value) {
        String text = String.valueOf(mUseDecimal ? GarageSale.distanceFormat.format((float) value / 10.0f) : value);
